"""
Production settings for cms-test project.
...
MEDIA_ROOT = "/var/www/cms_test_media"
...
STATIC_ROOT = "/var/www/cms_test_static"

STATIC_URL = "/static/"

NODE_MODULES_ROOT = "/var/www/cms_test_static"
...
INSTALLED_APPS = [
    ...
    "cms_test.apps.news",
    # "cms_test.apps.people",
    "cms_test.apps.sections",
    "cms_test.apps.site",
...
CACHE_MIDDLEWARE_KEY_PREFIX = "cms_test"
...
SECRET_KEY = "l$aw_o8-5%iapd!l)q0&%^o5*ng68&pmau0l#2gn&vv02k5dj1"
...
ADMIN_ANALYTICS_GOOGLE_API_KEY = 'wdwd'

# You can get your Client ID & Secret here: https://creativesdk.adobe.com/myapps.html
ADOBE_CREATIVE_SDK_ENABLED = True
ADOBE_CREATIVE_SDK_CLIENT_SECRET = 'wdwd'
ADOBE_CREATIVE_SDK_CLIENT_ID = '22'
...
SOCIAL_AUTH_GOOGLE_PLUS_KEY = 'ss'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = 'ss'
